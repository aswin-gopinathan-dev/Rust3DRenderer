...
impl AppWindow {
    pub fn new(sdl_context: &Sdl, video_subsystem: &sdl2::VideoSubsystem) -> Result<Self, String> {
        ...
        let mut window = video_subsystem.window("3D Renderer", screen_width, screen_height)
                                     .position_centered()
                                     .build()
    ...
    pub fn render_color_buffer(&mut self) -> Result<(), String> {
        ...
        let mut texture = texture_creator.create_texture_streaming(sdl2::pixels::PixelFormatEnum::ARGB8888, 
